      ...
      <Landing>
        <Section>
            ...
            <LandingMain>
                ...
                <p>No individual is the font of all wisdom. Stay humble. Stay learning. Stay succeeding</p>
            <LandingMain2 />
            <LinkDiv>
                <Link>
                  <button className='resumeButton' onClick={onButtonClick}> My Resume</button>
                </Link>
            </LinkDiv>
            <SideScroll>
